    ...
    <>
      <div className="relative flex pt-40 bg-black md:pt-40">
        <div className="items-center justify-center px-[10%] lg:px-[20%]">
          ...
          <h1 className='md:text-[48px] font-bold font-Outfit py-4'>Terms of Service</h1>
          <div>
            ...
            <div className='mb-8'>
              <h5 className='md:text-[22px] md:leading-[34px] font-Outfit font-bold'> 1. Services </h5>
            ...
            <div className='mb-8'>
              <h5 className='md:text-[22px] md:leading-[34px] font-Outfit font-bold'>2. Representation and Warranties</h5>{" "}
            ...
            <div className='mb-8'>
              <h5 className='md:text-[22px] md:leading-[34px] font-Outfit font-bold'> 3. Third party content </h5>
              <p className='md:text-[22px] md:leading-[34px] font-normal font-Outfit'>
            ...
            <div className='mb-8'>
              <h5 className='md:text-[22px] md:leading-[34px] font-Outfit font-bold'> 4. User contribution​ </h5>
              <p  className='md:text-[22px] md:leading-[34px] font-normal font-Outfit'>
            ...
            <div className="mb-8">
              <h5 className='md:text-[22px] md:leading-[34px] font-Outfit font-bold'> 5. Modifications terms and termination </h5>
              <p  className='md:text-[22px] md:leading-[34px] font-normal font-Outfit'>
            ...
            <div  className="mb-8">
              <h5 className='md:text-[22px] md:leading-[34px] font-Outfit font-bold'> 6. Communication </h5>
            ...
            <div className="mb-8">
              <h5 className='md:text-[22px] md:leading-[34px] font-Outfit font-bold'> 7. Indemnification </h5>
              <p className='md:text-[22px] md:leading-[34px] font-normal font-Outfit'>
